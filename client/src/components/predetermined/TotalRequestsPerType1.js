...
const TotalRequestsPerType1 = props => {
    ...
    const getResults = () => {
        ...
        axios.get("/api/predetermined/1", {
            ...
            if (!res.data.error) {
                props.setTextAndShowPopup("Fetched Results for query no.1");
...
export default TotalRequestsPerType1;