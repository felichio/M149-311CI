...
const LicensePlateMoreThanOnce7 = props => {
    ...
    const getResults = () => {
        ...
        axios.get("/api/predetermined/7", {
            ...
            if (!res.data.error) {
                props.setTextAndShowPopup("Fetched Results for query no.7");
...
export default LicensePlateMoreThanOnce7;