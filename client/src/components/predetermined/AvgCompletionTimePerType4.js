...
const AvgCompletionTimePerType4 = props => {
    ...
    const getResults = () => {
        ...
        axios.get("/api/predetermined/4", {
            ...
            if (!res.data.error) {
                props.setTextAndShowPopup("Fetched Results for query no.4");
...
export default AvgCompletionTimePerType4;