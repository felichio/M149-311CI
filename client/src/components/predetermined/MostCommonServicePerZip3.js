...
const MostCommonServicePerZip3 = props => {
    ...
    const getResults = () => {
        ...
        axios.get("/api/predetermined/3", {
            ...
            if (!res.data.error) {
                props.setTextAndShowPopup("Fetched Results for query no.3");
...
export default MostCommonServicePerZip3;